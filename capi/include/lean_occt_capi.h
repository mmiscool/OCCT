...
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_edge_vertex_inventory(
  LeanOcctContext*     the_context,
  const LeanOcctShape* the_shape,
  size_t               the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_vertex_point(
  LeanOcctContext*     the_context,
  const LeanOcctShape* the_shape,
  double*              the_xyz3);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_face_wire_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_face_wire(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_face_edge_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_face_edge(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_face_vertex_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_face_vertex(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_shell_face_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_shell_face(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_shell_wire_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_shell_wire(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_shell_edge_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_shell_edge(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_shell_vertex_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_shell_vertex(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_solid_shell_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_solid_shell(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_solid_face_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_solid_face(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_solid_wire_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_solid_wire(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_solid_edge_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_solid_edge(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
LEAN_OCCT_CAPI_EXPORT LeanOcctResult lean_occt_shape_root_solid_vertex_count(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t*               the_count);
LEAN_OCCT_CAPI_EXPORT LeanOcctShape* lean_occt_shape_root_solid_vertex(
  LeanOcctContext*      the_context,
  const LeanOcctShape*  the_shape,
  size_t                the_index);
