...
mod ffi {
    ...
    unsafe extern "C" {
        ...
        pub fn lean_occt_shape_edge_vertex_inventory(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        ...
        pub fn lean_occt_shape_root_face_wire_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_face_wire(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_face_edge_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_face_edge(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_face_vertex_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_face_vertex(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        ...
        pub fn lean_occt_shape_root_solid_shell_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_solid_shell(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_solid_face_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_solid_face(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_solid_wire_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_solid_wire(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_solid_edge_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_solid_edge(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
        pub fn lean_occt_shape_root_solid_vertex_count(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            count: *mut usize,
        ) -> LeanOcctResult;
        pub fn lean_occt_shape_root_solid_vertex(
            context: *mut LeanOcctContext,
            shape: *const LeanOcctShape,
            index: usize,
        ) -> *mut LeanOcctShape;
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct AnalyticSurfaceFaceMetadata {
    pub(crate) geometry_seed: FaceGeometry,
}
...
enum ShapeRustMetadata {
    ...
    AnalyticSurfaceFace(AnalyticSurfaceFaceMetadata),
    MultiFaceAnalyticResult(Vec<AnalyticSurfaceFaceMetadata>),
...
impl Context {
    ...
    pub fn make_box(&self, params: BoxParams) -> Result<Shape, Error> {
        let rust_metadata = box_analytic_result_metadata(params);
    ...
    pub fn edge_endpoints(&self, shape: &Shape) -> Result<EdgeEndpoints, Error> {
        if let Some(endpoints) = self.ported_edge_endpoints(shape)? {
            return Ok(endpoints);
        }
    ...
    pub fn edge_sample(&self, shape: &Shape, t: f64) -> Result<EdgeSample, Error> {
        if let Some(sample) = self.ported_edge_sample(shape, t)? {
            return Ok(sample);
        }
    ...
    pub fn edge_sample_at_parameter(
        ...
        if let Some(sample) = self.ported_edge_sample_at_parameter(shape, parameter)? {
            return Ok(sample);
        }
    ...
    pub fn edge_geometry(&self, shape: &Shape) -> Result<EdgeGeometry, Error> {
        if let Some(geometry) = self.ported_edge_geometry(shape)? {
            return Ok(geometry);
        }
    ...
    pub(crate) fn edge_vertex_inventory_shape_occt(
        &self,
        shape: &Shape,
        index: usize,
    ) -> Result<Shape, Error> {
        let raw = unsafe {
            ffi::lean_occt_shape_edge_vertex_inventory(self.raw.as_ptr(), shape.raw.as_ptr(), index)
        };
        self.wrap_shape(raw)
    }
    ...
    pub(crate) fn root_face_wire_shapes_occt(
        &self,
        face_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_face_wire_count(
                self.raw.as_ptr(),
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_face_wire(
                    self.raw.as_ptr(),
                    face_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_face_edge_shapes_occt(
        &self,
        face_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_face_edge_count(
                self.raw.as_ptr(),
                face_shape.raw.as_ptr(),
                &mut count,
            )
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_face_edge(
                    self.raw.as_ptr(),
                    face_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_face_vertex_shapes_occt(
        &self,
        face_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_face_vertex_count(
                self.raw.as_ptr(),
                face_shape.raw.as_ptr(),
                &mut count,
            )
    ...
    pub(crate) fn root_solid_shell_shapes_occt(
        &self,
        solid_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_solid_shell_count(
                self.raw.as_ptr(),
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_solid_shell(
                    self.raw.as_ptr(),
                    solid_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_solid_face_shapes_occt(
        &self,
        solid_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_solid_face_count(
                self.raw.as_ptr(),
                solid_shape.raw.as_ptr(),
                &mut count,
            )
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_solid_face(
                    self.raw.as_ptr(),
                    solid_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_solid_wire_shapes_occt(
        &self,
        solid_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_solid_wire_count(
                self.raw.as_ptr(),
                solid_shape.raw.as_ptr(),
                &mut count,
            )
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_solid_wire(
                    self.raw.as_ptr(),
                    solid_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_solid_edge_shapes_occt(
        &self,
        solid_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_solid_edge_count(
                self.raw.as_ptr(),
                solid_shape.raw.as_ptr(),
                &mut count,
            )
        ...
        for index in 0..count {
            let raw = unsafe {
                ffi::lean_occt_shape_root_solid_edge(
                    self.raw.as_ptr(),
                    solid_shape.raw.as_ptr(),
                    index,
                )
    ...
    pub(crate) fn root_solid_vertex_shapes_occt(
        &self,
        solid_shape: &Shape,
    ) -> Result<Vec<Shape>, Error> {
        let mut count = 0_usize;
        let result = unsafe {
            ffi::lean_occt_shape_root_solid_vertex_count(
                self.raw.as_ptr(),
                solid_shape.raw.as_ptr(),
                &mut count,
            )
    ...
    fn offset_surface_face_metadata_candidate(
        ...
        let basis_geometry = match self.ported_face_geometry(basis_face) {
            Ok(Some(geometry)) => geometry,
            Ok(None) => return Ok(None),
            Err(error) if error.to_string().contains("not a face") => return Ok(None),
            Err(error) => return Err(error),
        };

        if !offset_surface_face_metadata_supports_basis(basis_geometry.kind) {
            return Ok(None);
        }

        let basis = match basis_geometry.kind {
            SurfaceKind::Plane
            | SurfaceKind::Cylinder
            | SurfaceKind::Cone
            | SurfaceKind::Sphere
            ...
            SurfaceKind::Revolution | SurfaceKind::Extrusion => {
                match brep::ported_face_surface_descriptor(self, basis_face, basis_geometry)? {
                    Some(PortedFaceSurface::Swept(surface))
                        if ported_swept_surface_kind(surface) == basis_geometry.kind =>
                    {
    ...
    fn prism_swept_result_metadata_candidate(
        ...
        if let Some(basis_geometry) = self.swept_source_edge_geometry_candidate(source)? {
            return Ok(ShapeRustMetadata::SingleFaceSweptResult(
        ...
        let inventory = self.prism_swept_result_face_metadata_inventory(source, sweep_length)?;
        if inventory.is_empty() {
            Ok(ShapeRustMetadata::None)
        } else {
            Ok(ShapeRustMetadata::MultiFaceSweptResult(inventory))
        }
    }
    ...
    fn revolution_swept_result_metadata_candidate(
        ...
        let inventory = self.revolution_swept_result_face_metadata_inventory(source, angle)?;
        if inventory.is_empty() {
            Ok(ShapeRustMetadata::None)
        } else {
            Ok(ShapeRustMetadata::MultiFaceSweptResult(inventory))
    ...
    fn prism_swept_result_face_metadata_inventory(
        &self,
        source: &Shape,
        sweep_length: f64,
    ) -> Result<Vec<SweptSurfaceFaceMetadata>, Error> {
        self.swept_result_face_metadata_inventory(source, |basis_geometry| {
            swept_face_geometry_seed(
                SurfaceKind::Extrusion,
                basis_geometry.start_parameter,
                basis_geometry.end_parameter,
                -sweep_length,
    ...
    fn revolution_swept_result_face_metadata_inventory(
        &self,
        source: &Shape,
        angle: f64,
    ) -> Result<Vec<SweptSurfaceFaceMetadata>, Error> {
    ...
    fn swept_result_face_metadata_inventory<F>(
        &self,
        source: &Shape,
        mut seed_from_basis: F,
    ) -> Result<Vec<SweptSurfaceFaceMetadata>, Error>
    where
        F: FnMut(EdgeGeometry) -> FaceGeometry,
    {
        if self.describe_shape_occt(source)?.root_kind != ShapeKind::Face {
            return Ok(Vec::new());
        }

        let mut inventory = Vec::new();
        for source_edge in self.subshapes_occt(source, ShapeKind::Edge)? {
            let Ok(basis_geometry) = self.edge_geometry(&source_edge) else {
                continue;
            };
            if basis_geometry.kind != CurveKind::Ellipse {
                continue;
            }
            push_unique_swept_face_metadata(
                &mut inventory,
                SweptSurfaceFaceMetadata {
                    geometry_seed: seed_from_basis(basis_geometry),
                },
            );
        }
...
fn box_analytic_result_metadata(params: BoxParams) -> ShapeRustMetadata {
    match box_analytic_face_metadata_inventory(params) {
...
fn box_analytic_face_metadata_inventory(
    params: BoxParams,
) -> Option<Vec<AnalyticSurfaceFaceMetadata>> {
    let [dx, dy, dz] = params.size;
    if !params.origin.iter().all(|value| value.is_finite()) {
        return None;
    }
    if !box_size_component_supported(dx)
        || !box_size_component_supported(dy)
        || !box_size_component_supported(dz)
    {
        return None;
    }

    let mut inventory = Vec::new();
    for [u_min, u_max, v_min, v_max] in
        [[0.0, dz, -dy, 0.0], [0.0, dz, 0.0, dx], [0.0, dx, 0.0, dy]]
    {
        push_unique_analytic_face_metadata(
            &mut inventory,
            AnalyticSurfaceFaceMetadata {
                geometry_seed: plane_face_geometry_seed(u_min, u_max, v_min, v_max),
            },
        );
    }
...
fn push_unique_analytic_face_metadata(
    inventory: &mut Vec<AnalyticSurfaceFaceMetadata>,
    metadata: AnalyticSurfaceFaceMetadata,
) {
    if !inventory
        .iter()
        .any(|existing| analytic_face_metadata_equivalent(*existing, metadata))
    {
        inventory.push(metadata);
    }
}

fn analytic_face_metadata_equivalent(
    lhs: AnalyticSurfaceFaceMetadata,
    rhs: AnalyticSurfaceFaceMetadata,
) -> bool {
    face_geometry_seed_equivalent(lhs.geometry_seed, rhs.geometry_seed)
}

fn push_unique_swept_face_metadata(
    inventory: &mut Vec<SweptSurfaceFaceMetadata>,
    metadata: SweptSurfaceFaceMetadata,
) {
    if !inventory
        .iter()
        .any(|existing| swept_face_metadata_equivalent(*existing, metadata))
    {
        inventory.push(metadata);
    }
}

fn swept_face_metadata_equivalent(
    lhs: SweptSurfaceFaceMetadata,
    rhs: SweptSurfaceFaceMetadata,
) -> bool {
    face_geometry_seed_equivalent(lhs.geometry_seed, rhs.geometry_seed)
}

fn face_geometry_seed_equivalent(lhs: FaceGeometry, rhs: FaceGeometry) -> bool {
    lhs.kind == rhs.kind
        && (lhs.u_min - rhs.u_min).abs() <= 1.0e-12
        && (lhs.u_max - rhs.u_max).abs() <= 1.0e-12
        && (lhs.v_min - rhs.v_min).abs() <= 1.0e-12
        && (lhs.v_max - rhs.v_max).abs() <= 1.0e-12
}
...
impl Shape {
    ...
    pub(crate) fn analytic_surface_face_metadata(&self) -> Option<AnalyticSurfaceFaceMetadata> {
        match &self.rust_metadata {
            ShapeRustMetadata::AnalyticSurfaceFace(metadata) => Some(metadata),
            ShapeRustMetadata::OffsetSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceOffsetResult(_)
            | ShapeRustMetadata::MultiFaceOffsetResult(_)
            | ShapeRustMetadata::MultiFaceAnalyticResult(_)
    ...
    pub(crate) fn multi_face_analytic_result_metadata(
        &self,
    ) -> Option<&[AnalyticSurfaceFaceMetadata]> {
        match &self.rust_metadata {
            ShapeRustMetadata::MultiFaceAnalyticResult(metadata) => Some(metadata.as_slice()),
            ShapeRustMetadata::AnalyticSurfaceFace(_)
            | ShapeRustMetadata::OffsetSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceOffsetResult(_)
            | ShapeRustMetadata::MultiFaceOffsetResult(_)
    ...
    pub(crate) fn multi_face_swept_result_metadata(&self) -> Option<&[SweptSurfaceFaceMetadata]> {
        match &self.rust_metadata {
            ShapeRustMetadata::MultiFaceSweptResult(metadata) => Some(metadata.as_slice()),
            ShapeRustMetadata::SweptSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceSweptResult(_)
            | ShapeRustMetadata::OffsetSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceOffsetResult(_)
    ...
    #[doc(hidden)]
    pub fn has_rust_analytic_surface_face_metadata(&self) -> bool {
        matches!(
            self.rust_metadata,
            ShapeRustMetadata::AnalyticSurfaceFace(_)
        )
    ...
    #[doc(hidden)]
    pub fn rust_multi_face_swept_source_count(&self) -> Option<usize> {
        match &self.rust_metadata {
            ShapeRustMetadata::MultiFaceSweptResult(metadata) => Some(metadata.len()),
            ShapeRustMetadata::OffsetSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceOffsetResult(_)
            | ShapeRustMetadata::MultiFaceOffsetResult(_)
            | ShapeRustMetadata::AnalyticSurfaceFace(_)
    ...
    #[doc(hidden)]
    pub fn rust_multi_face_analytic_source_count(&self) -> Option<usize> {
        match &self.rust_metadata {
            ShapeRustMetadata::MultiFaceAnalyticResult(metadata) => Some(metadata.len()),
            ShapeRustMetadata::OffsetSurfaceFace(_)
            | ShapeRustMetadata::SingleFaceOffsetResult(_)
            | ShapeRustMetadata::MultiFaceOffsetResult(_)
            | ShapeRustMetadata::AnalyticSurfaceFace(_)
    ...
    pub(crate) fn with_multi_face_swept_result_metadata(
        mut self,
        metadata: Vec<SweptSurfaceFaceMetadata>,
    ) -> Self {
        self.rust_metadata = ShapeRustMetadata::MultiFaceSweptResult(metadata);
        self
    }

    pub(crate) fn with_multi_face_analytic_result_metadata(
        mut self,
        metadata: Vec<AnalyticSurfaceFaceMetadata>,
    ) -> Self {
        self.rust_metadata = ShapeRustMetadata::MultiFaceAnalyticResult(metadata);
        self
    }
    ...
    pub(crate) fn with_analytic_surface_face_metadata(
        mut self,
        metadata: AnalyticSurfaceFaceMetadata,
    ) -> Self {
        self.rust_metadata = ShapeRustMetadata::AnalyticSurfaceFace(metadata);
        self
    }
